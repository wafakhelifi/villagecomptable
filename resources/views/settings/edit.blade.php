                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('settings.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname', $user->firstname) }}" required autocomplete="given-name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname', $user->lastname) }}" required autocomplete="family-name">
                        ...
                        <div class="row mb-3">
                            <label for="post" class="col-md-4 col-form-label text-md-end">Poste</label>

                            <div class="col-md-6">
                                <input id="post" type="text" class="form-control @error('post') is-invalid @enderror" name="post" value="{{ old('post', $user->post) }}" required>
